...
<html lang="pt-br">
    <head>
        ...
        <title>Sindicato de Pesca EtecVav</title>
    </head>
    ...
    <body>
       ...
       <header>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-image: linear-gradient(to bottom,#25471e,#39722d);">
          <div class="container-fluid">
